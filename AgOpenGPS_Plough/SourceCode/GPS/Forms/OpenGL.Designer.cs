...
namespace AgOpenGPS
{
    public partial class FormGPS
    {
        ...
        private void DrawCompassText()
        {
            ...
            font.DrawText(center + 10, 150, "Plough", 1);
            font.DrawText(center + 10, 180, ploughWidth.ToString() + "cm", 1);
            if(ploughMode == 0) font.DrawText(center + 10, 210, "Section Off", 1);
            else if (ploughMode == 1) font.DrawText(center + 10, 210, "Auto Config Off", 1);
            ...
            else if (ploughMode == 8) font.DrawText(center + 10, 210, "No Line", 1);
