...
namespace AgOpenGPS
{
    public partial class FormConfig
    {
        ...
        private void tabAMachine_Enter(object sender, EventArgs e)
        {
            ...
            nudUser1.Value = 200 + Properties.Vehicle.Default.setArdMac_user1;
            nudUser2.Value = 0; 
            nudUser3.Value = 0; 
            nudUser4.Value = 0;
        ...
        private void SaveSettingsMachine()
        {
            ...
            Properties.Vehicle.Default.setArdMac_user1 = (byte)(nudUser1.Value - 200);
            Properties.Vehicle.Default.setArdMac_user2 = 0;
            Properties.Vehicle.Default.setArdMac_user3 = 0;
            Properties.Vehicle.Default.setArdMac_user4 = 0;
            ...
            pboxSendMachine.Visible = false;
            mf.p_238.pgn[mf.p_238.user2] = 0;       //Make sure calabration instruction is back to zero
        }
